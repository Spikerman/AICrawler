...
public class AppStorePageProcessor implements PageProcessor {
    ...
    //小米应用商店解析
    private void pageParserForMi(Page page, AppInfo appInfo) {
        ...
        appInfo.apkSize = page.getHtml().xpath("//div[@class=look-detail]/div[1]/ul[1]/li[2]/text()").toString();
